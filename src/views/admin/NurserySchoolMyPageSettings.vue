      ...
      <div class="row row-3">
        ...
        <div class="col-md-9 py-3">
          <div class="row py-2">
            ...
            <div class="col-md-4">
              <p class="m-0 text-right" >{{ schoolInfo.instagram_link}}</p>
            </div>
          </div>
          <div class="row py-2">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <p class="m-0 text-right" >{{ schoolInfo.twitter_link}}</p>
            </div>
          </div>
          <div class="row py-2">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <p class="m-0 text-right" >{{ schoolInfo.facebook_link}}</p>
            </div>
          </div>
        </div>
      </div>
      <div class="row text-right mt-2">
        <router-link class="bottom-link text-decoration-underline" :to="{name:'Admin.NurserySchoolMyPageSettingsEdit'}">修正する ＞</router-link>
      </div>
